...
import 'package:app_mapeo/services/login_services.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
        ...
        if (e.toString().contains('Usuario o clave incorrecto')) {
          errorMessage = 'Usuario o clave incorrecto';
        } else if (e.toString().contains('sin acceso')) {
          errorMessage = 'Usuario sin acceso a la aplicación';
